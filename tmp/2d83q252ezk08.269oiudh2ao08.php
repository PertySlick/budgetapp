  ...
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?= $BASE ?>">R & P Budgeting</a>
      </div>
      <div class="collapse navbar-collapse" id="main-nav">
        <ul class="nav navbar-nav">
          <?php if ($userStatus): ?>
            
              <li class="<?= $PATH=='/userHome'?'active':'' ?>"><a href="<?= $BASE . '/userhome' ?>" title="My Budget Summary">Summary</a></li>
              <li class="<?= $PATH=='/income'?'active':'' ?>"><a href="<?= $BASE . '/income' ?>" title="Manage Your Income">My Income</a></li>
              <li class="<?= $PATH=='/expense'?'active':'' ?>"><a href="<?= $BASE . '/expense' ?>" title="Manage Your Expenses">My Expenses</a></li>
              <li class="<?= $PATH=='/logout'?'active':'' ?>"><a href="<?= $BASE . '/logout' ?>" title="Log Out">Log Out</a></li>
